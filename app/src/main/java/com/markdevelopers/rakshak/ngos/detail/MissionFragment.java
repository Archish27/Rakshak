...
public class MissionFragment extends BaseFragment implements NgoContract.NgoView {
    WebView wvMain;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ngoPresenter.getNgoMission(new SharedPreferenceManager(getActivity().getApplicationContext()).getAccessToken(), id);
        return view;
    }
