...
public class StoriesFragment extends BaseFragment implements NgoContract.NgoView {
    WebView wvMain;
...
//        ngoPresenter.getNgoStories(new SharedPreferenceManager(getActivity().getApplicationContext()).getAccessToken(), id);
    }
